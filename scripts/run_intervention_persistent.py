...
ALLOWED = {"scripts.intervention_packet", "scripts.intervention_study", "scripts.intervention_replay",
           "scripts.intervention_use", "scripts.intervention_artifacts", "scripts.intervention_checks", "pytest", "ruff"}
...
def main():
    ...
    try:
        ...
        attempted = [*ROOT.glob("experiments/intervention_*.py"), *ROOT.glob("scripts/intervention_*.py"),
                     *ROOT.glob("tests/test_intervention*.py"), ROOT / "research-continuation/47_intervention_understanding/PROTOCOL.md"]
        source_hashes = {}
