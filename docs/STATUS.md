...
Published implementation [`94fb2d9`](https://github.com/Arnav123-s/sera/commit/94fb2d9e98a4cc92ea68c9a16617e8a4124be97f) passed [both GitHub platform jobs](https://github.com/Arnav123-s/sera/actions/runs/35414873944): **579 Linux tests and 580 Windows tests**, with 46/45 established optional-fixture skips. Locally, all 613 regression tests and 12 subsequent portability checks passed. The preserved Linux restoration failure was repaired without changing learned weights or scientific decisions. [Verification, costs and original logs](../research-continuation/47_intervention_understanding/publication/VERIFICATION.md) · [One complete investigation](../research-continuation/47_intervention_understanding/publication/WORKED_EXAMPLE.md) · [Resumable release](https://github.com/Arnav123-s/sera/releases/tag/research-2026-09-18-interventions).
...
## Preserved Stage 29 human-text integration
...
Full local regression reached its 120-second cap; the partial log is retained. Targeted reader/source tests passed, followed by full Linux/Windows success in [run #36](https://github.com/Arnav123-s/sera/actions/runs/35296019350). [Stage 29 receipt](../research-continuation/29_human_reading/publication.json).

Notifications for failed runs #30–#32 refer to earlier commits and the saved-state replay defect documented under F06. They are historical records, not the result of run #36 or a newer release. Numerical time remains governed by the live ledger; source intake grants no additional resources.
