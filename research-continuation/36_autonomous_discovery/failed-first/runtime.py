...
class AutonomousSession:
    ...
    def advance(self):
        ...
        event = {"sequence": sequence, "chosen_depth": depth, "frontier_before": sorted(frontier+[depth]),
                 ...
                 "reward": reward, "procedure_improvement_points": 0}
...
def study():
    ...
    result = {"contracts": contracts(), "owner": model_identity(session.owner), "state": session.state,
              "evaluations": evaluations, "checked_routes": len(evaluations), "fresh_polynomials": 32,
              ...
              "procedure_improvement_points": 0,
